...
#define CS_PDIR P1DIR
#define CS_POUT	P1OUT
#define CS	BIT3

#define GDO2_PDIR P1DIR
#define GDO2_PIN  P1IN
#define GDO2	BIT4

#define GDO0_PDIR P1DIR
#define GDO0_PREN P1REN
#define GDO0_POUT P1OUT
#define GDO0_PIN  P1IN
#define GDO0	BIT0

#define SPI_PSEL P1SEL
#define SPI_PSEL2 P1SEL2
